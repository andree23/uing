    ...
    <div class="col-md-12 grid-margin">
      <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="d-flex justify-content-between align-items-end flex-wrap">
          <button @click="create()" class="btn btn-primary mt-2 mt-xl-0" v-if="index">Add Serie</button>
             ...
             <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    placeholder="Serie Backdrop Path"
                    class="form-control"
                    id="backdrop_path"
                    name="backdrop_path"
                    type="text"
              ...
              <div class="form-group">
                ...
                <table aria-describedby="substitles table" class="table table-striped table-links">
                  ...
                  <tbody name="linksubtitles">
                    <tr
                      v-for="(item, index) in form.serie.seasons[selectedSeason].episodes[selectedEpisode].substitles"
                      :key="index"
                      class="row"
                    >
                      <td class="col-md-2">
                        <button
                          class="btn btn-sm btn-danger"
                          @click.prevent="deleteLinkSubs(item, index)"
                        >
                          <em class="far fa-trash-alt"></em>
                        </button>
                      </td>
    ...
    deleteLinkSubs(linksubstitle, index) {
      this.showConfirm(async () => {
        try {
          if (linksubstitle.id) {
            const response = await axios.delete(
              url + "/admin/series/substitles/destroy/" + linksubstitle.id
            );
